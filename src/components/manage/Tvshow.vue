...
<div class="videos">
  <div class="cont-header">
    ...
    <div class="head-right">
      <el-button type="primary" @click="creatVideo = true">Create Show</el-button>
        <el-dialog title="Create New Video" width="40%" top="30px" :visible.sync="creatVideo">
          <el-form :model="form">
            <!-- 标题 -->
            <el-form-item>
          ...
          <div slot="footer" class="dialog-footer">
            <el-button type="danger" @click="creatVideo = false">Cancel</el-button>
            <el-button type="success" @click="saveVideo">Create Show</el-button>
          </div>
        </el-dialog>
      <el-button type="primary" @click="creatMulitVideo = true">Bulk-Created from files</el-button>
        <el-dialog title="Bulk-Created from files" width="40%" height="auto" top="30px" :visible.sync="creatMulitVideo">
          ...
          <div slot="footer" class="dialog-footer">
            <el-button type="danger" @click="creatMulitVideo = false">Cancel</el-button>
  ...
  <div class="cont-cont">
    ...
    <div class="video-item"
      v-for="v in search(keywords)"
      :key="v.id"
      >
      <router-link :to="{name:'sdetail',query:{id:v.id}}">
        <div class="cover-url">
  ...
  data () {
    return {
      ...
      sorts: [
        { id: 1, name: 'A-Z' },
        { id: 2, name: 'Z-A' },
        { id: 3, name: 'Latest Release' },
        { id: 4, name: 'Oldest Release' },
        { id: 5, name: 'Most Recently Added' },
        { id: 6, name: 'Frist Added' }
      ],
      ...
      currentPage: 1, // 当前页
      videoList: [], // 视频列表
      creatVideo: false, // 创建新视频dialog
      creatMulitVideo: false, // 批量创建
      mulitForm: {
        videos: []
      }, // 批量提交的数据
      files: [
